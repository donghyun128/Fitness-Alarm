...
## 개발 동기
유튜브에서 팔굽혀펴기(푸쉬업) 갯수를 늘리는 방법에 대한 영상을 본 적이 있습니다. 그 중 하나는 아침에 기상하자마자 최대 횟수로 푸시업을 하는 것이였습니다.

실제로 해보니 그 날의 주간 컨디션이 굉장히 좋았습니다. 아침에 운동을 하면 개운하게 하루를 시작할 수 있었죠. 이에 착안하여 설정한 운동을 모두 마치면 꺼지는 알람이 있으면 좋겠다고 생각했습니다. 운동을 하면 꺼지는 어플리케이션은 기존에 존재했습니다. (알라미 앱 스쿼트 기능 등) 그러나 실제로 자세를 인식하지는 않고 간접적인 방식으로 운동을 감지했습니다.
